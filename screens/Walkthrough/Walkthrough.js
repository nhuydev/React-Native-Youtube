...
import WalkthroughSlider2 from './WalkthroughSlider2';

const Walkthrough = ({ navigation }) => {
    // Walkthrough 2
    const [walkthrough2Animated, setWalkthrough2Animated] = React.useState(false);
                    ...
                    return (
                        <View style={{ width: SIZES.width, justifyContent: 'center' }}>
                            ...
                            <View style={{ flex: 1, justifyContent: 'center' }}>
                                {index === 0 && <WalkthroughSlider />}
                                {index === 1 && <WalkthroughSlider2 animate={walkthrough2Animated} />}
                            </View>
